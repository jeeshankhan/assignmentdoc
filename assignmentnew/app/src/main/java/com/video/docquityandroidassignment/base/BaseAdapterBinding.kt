...
class BaseAdapterBinding<S : Any>(
...
) : RecyclerView.Adapter<BaseAdapterBinding.DataBindingViewHolder>(), Filterable {
    ...
    private val filter = object : Filter() {
        override fun performFiltering(constraint: CharSequence?): FilterResults {
            ...
            val filteredList = if (query.isEmpty()) {
                this@BaseAdapterBinding.originalItems
            } else {
                this@BaseAdapterBinding.originalItems!!.filter { item ->
        ...
        override fun publishResults(constraint: CharSequence?, results: FilterResults?) {
            ...
            this@BaseAdapterBinding.mObjects = filteredList
            this@BaseAdapterBinding.notifyDataSetChanged()
        }
    }
